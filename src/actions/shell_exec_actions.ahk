...
; ==============================
; EJEMPLOS DE USO CON RegisterKeymap - SINTAXIS INTELIGENTE
; ==============================
;
; SINTAXIS BÁSICA (Hide por defecto):
; RegisterKeymap("leader", "p", "e", "Excel", ShellExec("C:\Program Files\Microsoft Office\root\Office16\EXCEL.EXE"), false, 1)
; RegisterKeymap("leader", "p", "n", "Notepad", ShellExec("notepad.exe"), false, 1)
; RegisterKeymap("leader", "p", "c", "Calculator", ShellExec("calc.exe"), false, 1)
;
; CON VISIBILIDAD:
; RegisterKeymap("leader", "p", "t", "Terminal", ShellExec("cmd.exe", "Show"), false, 1)
; RegisterKeymap("leader", "p", "p", "PowerShell", ShellExec("powershell.exe", "Show"), false, 1)
;
; CON DIRECTORIO DE TRABAJO:
; RegisterKeymap("leader", "p", "g", "Git Status", ShellExec("git status", "C:\MyProject"), false, 1)
; RegisterKeymap("leader", "p", "f", "Project Folder", ShellExec("explorer.exe", "C:\MyProject"), false, 1)
;
; CON ARCHIVO DE CONFIGURACIÓN (AUTO-DETECTADO):
; RegisterKeymap("leader", "p", "k", "Kanata", ShellExec("C:\Users\canto\kanata\kanata.exe", "C:\Users\canto\Work\Hybrid-CapsLock-fork\kanata.kbd"), false, 1)
; RegisterKeymap("leader", "p", "v", "VS Code Config", ShellExec("code.exe", "settings.json"), false, 1)
;
; CON MÚLTIPLES PARÁMETROS:
; RegisterKeymap("leader", "p", "s", "Server Start", ShellExec("node.exe server.js", "C:\MyApp", "Show"), false, 1)
; RegisterKeymap("leader", "p", "b", "Backup Script", ShellExec("backup.bat", "config.ini", "C:\Scripts", "Hide"), false, 1)
;
; SCRIPTS Y ARCHIVOS ESPECIALES:
; RegisterKeymap("leader", "p", "r", "Reset VBS", ShellExec("reset.vbs"), false, 1)
; RegisterKeymap("leader", "p", "i", "Install AHK", ShellExec("install.ahk", "Show"), false, 1)
